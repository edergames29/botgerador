...
//---------------TempoLimiteParaExibirCartasNoComeco-------------------//
...
const clicar = (x,corve) => {
    ...
    if (contagem == 1) {
        ...
        pegarCartaE[a].setAttribute('class','tudopreto'),pegarCartaE[b].setAttribute('class','tudopreto')},400)
        ...
        if(ultimaCorA == ultimaCorB && ultimaCorB == ultimaCorA){//verificar se cores sao iguals
            if(a == b){
                ...
                pegarCartaE[a].removeAttribute('onclick'),pegarCartaE[b].removeAttribute('onclick')

                setTimeout(function(){
                pegarCartaE[a].setAttribute('class','verde'),pegarCartaE[b].setAttribute('class','verde')
                },401)
